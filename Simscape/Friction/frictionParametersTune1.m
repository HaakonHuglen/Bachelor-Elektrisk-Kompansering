...
matFile  = 'Friction_parametersTune6.mat';
...
%% ===================== SPLIT SIMULATION EXTEND / RETRACT =====================
...
%% ===================== SORT EACH SIMULATION DIRECTION =====================

[x_sim_extend, idxExtSim] = sort(x_sim_extend);
F_sim_extend = F_sim_extend(idxExtSim);

[x_sim_retract, idxRetSim] = sort(x_sim_retract);
F_sim_retract = F_sim_retract(idxRetSim);
...
pA_bar_raw = pA_bar_raw(idxMeas);
pB_bar_raw = pB_bar_raw(idxMeas);
...
plot(t_sim, F_sim, 'LineWidth', 1.6);
