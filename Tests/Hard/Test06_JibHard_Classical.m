%% ============================================================
%  Test 6 - Jib hard load, classical feedforward
%
...
%       Put this script in the same folder as: JibHardClassic.csv
...
csvFileName = 'JibHardClassic.csv';
fallbackRelativeCsvFile = fullfile('Tests','Hard','JibHardClassic.csv');
...
fprintf('\n============================================================\n');
fprintf('Test 6 - Jib hard load, classical feedforward\n');
fprintf('CSV file: %s\n', csvPath);
...
xlabel('Time [s]');
ylabel('Position [mm]');
title('Test 6 - Jib hard load, classical feedforward');
...
title('Test 6 - Jib hard load, classical feedforward - control signal');
