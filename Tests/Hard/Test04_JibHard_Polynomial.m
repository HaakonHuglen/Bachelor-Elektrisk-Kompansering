%% ============================================================
%  Test 4 - Jib hard load, polynomial feedforward
%
...
%       Put this script in the same folder as: JibHard.csv
...
csvFileName = 'JibHard.csv';
fallbackRelativeCsvFile = fullfile('Tests','Hard','JibHard.csv');
...
fprintf('\n============================================================\n');
fprintf('Test 4 - Jib hard load, polynomial feedforward\n');
fprintf('CSV file: %s\n', csvPath);
...
xlabel('Time [s]');
ylabel('Position [mm]');
title('Test 4 - Jib hard load, polynomial feedforward');
...
title('Test 4 - Jib hard load, polynomial feedforward - control signal');
