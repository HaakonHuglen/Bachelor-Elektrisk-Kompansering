%% ============================================================
%  Test 5 - Main hard load, classical feedforward
%
...
%       Put this script in the same folder as: MainHardClassic.csv
...
csvFileName = 'MainHardClassic.csv';
fallbackRelativeCsvFile = fullfile('Tests','Hard','MainHardClassic.csv');
...
fprintf('\n============================================================\n');
fprintf('Test 5 - Main hard load, classical feedforward\n');
fprintf('CSV file: %s\n', csvPath);
...
xlabel('Time [s]');
ylabel('Position [mm]');
title('Test 5 - Main hard load, classical feedforward');
...
title('Test 5 - Main hard load, classical feedforward - control signal');
