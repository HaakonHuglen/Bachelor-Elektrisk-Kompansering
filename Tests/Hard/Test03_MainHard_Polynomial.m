%% ============================================================
%  Test 3 - Main hard load, polynomial feedforward
%
...
%       Put this script in the same folder as: MainHard.csv
...
csvFileName = 'MainHard.csv';
fallbackRelativeCsvFile = fullfile('Tests','Hard','MainHard.csv');
...
fprintf('\n============================================================\n');
fprintf('Test 3 - Main hard load, polynomial feedforward\n');
fprintf('CSV file: %s\n', csvPath);
...
xlabel('Time [s]');
ylabel('Position [mm]');
title('Test 3 - Main hard load, polynomial feedforward');
...
title('Test 3 - Main hard load, polynomial feedforward - control signal');
