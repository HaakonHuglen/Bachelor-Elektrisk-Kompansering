%% ============================================================
%  Test 2 - Jib easy load, polynomial feedforward
%
...
%       Put this script in the same folder as: JibEasy.csv
...
csvFileName = 'JibEasy.csv';
fallbackRelativeCsvFile = fullfile('Tests','Easy','JibEasy.csv');
...
fprintf('\n============================================================\n');
fprintf('Test 2 - Jib easy load, polynomial feedforward\n');
fprintf('CSV file: %s\n', csvPath);
...
xlabel('Time [s]');
ylabel('Position [mm]');
title('Test 2 - Jib easy load, polynomial feedforward');
...
title('Test 2 - Jib easy load, polynomial feedforward - control signal');
