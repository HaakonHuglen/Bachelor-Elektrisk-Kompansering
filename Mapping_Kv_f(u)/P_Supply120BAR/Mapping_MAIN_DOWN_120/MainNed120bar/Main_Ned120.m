...
%% ===================== INNSTILLINGER =====================
folderPathMain = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply120BAR\Mapping_MAIN_DOWN_120\MainNed120bar';
...
%% ===================== LES MAPPE =====================
T_main = lesMappeMainNed(folderPathMain, false, activeSide, A_piston, A_annulus, Cd, rho, velThreshold);
...
function plotMedFitMainNed(u, y, ylbl, ttl, varName)
    ...
    % Main ned: negative u-verdier, ikke bruk overgangsområdet nær dødbånd
    ...
    if any(deadband)
        u_db = min(u(deadband));   % nedre grense for dødbånd (negativ retning)
...
%% ===================== LES MAPPE MAIN NED =====================
function T = lesMappeMainNed(folderPath, isDeadbandFolder, activeSide, A_piston, A_annulus, Cd, rho, velThreshold)
