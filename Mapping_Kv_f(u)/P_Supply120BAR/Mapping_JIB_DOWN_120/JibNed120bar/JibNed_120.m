...
folderPath = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply120BAR\Mapping_JIB_DOWN_120\JibNed120bar';
...
% Polynomfit (grad 3) hvis nok punkter
...
xlabel('u [%]');
ylabel('A_d [m^2]');
title('Effektivt oriifce-areal vs u');