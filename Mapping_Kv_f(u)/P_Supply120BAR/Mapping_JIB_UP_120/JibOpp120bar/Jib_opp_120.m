...
%% ===================== INNSTILLINGER =====================
folderPathMain = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply120BAR\Mapping_JIB_UP_120\JibOpp120bar';
...
function plotMedFitJibOpp(u, y, ylbl, ttl, varName)
    ...
    % Jib opp: positive u-verdier, ikke bruk overgangsområdet nær dødbånd
...
function T = lesMappeJibOpp(folderPath, isDeadbandFolder, activeSide, A_piston, A_annulus, Cd, rho, velThreshold)
    ...
    for k = 1:nFiles
        ...
        % Jib opp: +100 % -> 10 V, 0 % -> 5 V hvis U_ref mangler
        if all(isnan(uRef))
