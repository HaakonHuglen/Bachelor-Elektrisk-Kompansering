...
%% ===================== INNSTILLINGER =====================
folderPathMain = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply180BAR\Mapping_MAIN_NED_180\MainNed180bar';
...
%% ===================== FIGUR 4: Ad vs u =====================
plotMedFit(u, Ad, 'A_d [m^2]', 'Effektivt orifice-areal vs u - Main ned', 'A_d', 'ned');

%% ===================== FIGUR 5: Kv vs u =====================
plotMedFit(u, Kv, 'K_v [L/(min \cdot \surdbar)]', 'K_v vs u - Main ned', 'K_v', 'ned');
