...
%% ===================== INNSTILLINGER =====================
folderPathMain = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply180BAR\Mapping_MAIN_OPP_180\MainOpp180bar';
...
%% ===================== FIGUR 4: Ad vs u =====================
plotMedFit(u, Ad, 'A_d [m^2]', 'Effektivt orifice-areal vs u - Main opp', 'A_d', 'opp');

%% ===================== FIGUR 5: Kv vs u =====================
plotMedFit(u, Kv, 'K_v [L/(min \cdot \surdbar)]', 'K_v vs u - Main opp', 'K_v', 'opp');
