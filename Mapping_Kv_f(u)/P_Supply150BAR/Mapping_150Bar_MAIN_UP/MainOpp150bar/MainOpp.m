...
folderPath = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply150BAR\Mapping_150Bar_MAIN_UP\MainOpp150bar';
...
uV_exp    = nan(nFiles,1);   % forventet ventilsignal fra prosent
uValve_mean = nan(nFiles,1); % faktisk referansesignal logget i fil
...
for k = 1:nFiles
    ...
    % Forventet volt fra prosent: 0% -> 5 V, 100% -> 10 V
    ...
    % Main opp: aktiv flowbane antatt P -> A
...
%% ===================== EXPORT =====================
writetable(results, fullfile(folderPath, 'results_main_up_from_csv.csv'));
