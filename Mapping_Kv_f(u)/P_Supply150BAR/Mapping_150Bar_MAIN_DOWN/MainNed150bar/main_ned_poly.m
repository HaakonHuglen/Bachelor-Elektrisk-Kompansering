...
%% ===================== SETTINGS =====================
resultsFile = 'C:\Users\hakon\OneDrive - Universitetet i Agder\Skrivebord\BACHELOR_PROSJEKT\Bachelor-Oppgave---Elektrisk-Kompansering\Mapping_Kv_f(u)\P_Supply150BAR\Mapping_150Bar_MAIN_DOWN\MainNed150bar\results_combined_main_down.csv';
...
% Main ned: direkte negativt TwinCAT-signal
...
%% ===================== PRINT RESULT =====================
fprintf('\n====================================================\n');
fprintf('TwinCAT-polynom: MAIN NED 150 bar\n');
fprintf('====================================================\n');
...
ylabel('u_{ctrl} [-]');
title('TwinCAT-polynom: direkte u_{FF} = f(K_v) - Main ned 150 bar');
